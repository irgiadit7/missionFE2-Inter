    ...
    return (
        <form action="">
            ...
            <div className="space-y-3 mt-6">
                ...
                <Link to="/login" className="block w-full text-center py-2 px-4 rounded-full font-semibold text-green-600 border border-green-600 hover:bg-green-50 transition-colors">
                    Masuk
                </Link>
            </div>
